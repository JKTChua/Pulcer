...
public class Ulcer extends Activity
{
	...
	protected void loadFromDb()
	{
		try
		{
			...
			String args[]={""+groupId};
			ulcerListData = (ArrayList<UlcerEnt>) dao.select(UlcerEnt.class, false, "group_id=", args, null, null, null, null);
		}
		catch(Exception e)
		{
			Log.d(CLIPBOARD_SERVICE, "Error querying from database!");
		}
		try
		{
