...
public class AccordionView extends LinearLayout {
	...
	public AccordionView(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			headerSubtext = a.getResourceId(R.styleable.accordion_header_layout_subtext_id, 0);
...
//		((TextView) view.findViewById(headerSubtext)).setText(sectionSubtext[position]);
